...
export default function Home() {
  ...
  function ratingSubmitHandler(e) {
    if (!rating) return setErrorSubmit(true);
    e.preventDefault();
    setRatedStat(true);
      ...
      {errorSubmit ? (
        <div className="toast toast-top toast-center">
          <div className="alert alert-error">
            ...
            <span>Please click one of rating options!</span>
          </div>
        </div>
      ) : (
        ""
        ...
        <section>
          {ratedStat ? (
            <div className="card shadow-xl">
              <div className="card-body p-10 gap-6 md:gap-8 max-w-[411px] items-center text-center rounded-3xl bg-red-500">
                <svg className="w-48" viewBox="0 0 162 108" xmlns="http://www.w3.org/2000/svg">
                  <g fill="none">
              ...
              <div className="card-body max-w-[411px] p-6 md:p-8 gap-6 rounded-3xl">
                ...
                <div className="grid gap-5 md:gap-6">
                  <div className="flex justify-between">
                    <input className="btn" value="1" onClick={ratingClickHandler} type="radio" name="options" aria-label="1" />
                    <input className="btn" value="2" onClick={ratingClickHandler} type="radio" name="options" aria-label="2" />
                    <input className="btn" value="3" onClick={ratingClickHandler} type="radio" name="options" aria-label="3" />
                    <input className="btn" value="4" onClick={ratingClickHandler} type="radio" name="options" aria-label="4" />
                    <input className="btn" value="5" onClick={ratingClickHandler} type="radio" name="options" aria-label="5" />
                  </div>
